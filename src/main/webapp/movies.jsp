	...
	<div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			<div class="container page-wrapper">
				<a href="index.jsp">Home</a> » <span class="breadcrumb_last" aria-current="page">movies</span>
			</div>
		</nav>
	</div>
	<!--/movies -->
							...
							<div class="modal fade Rocketman" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="bookbtn">
											<!-- window.open('ticket-booking.jsp','_blank'); -->
											<button type="button" class="btn btn-success"
												onclick="location.href='ticket-booking.jsp';">Book</button>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Mulan</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m10.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m11.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">The Lego</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
													</span>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m12.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">The Hustle</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
